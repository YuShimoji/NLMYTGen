...
**将来:** RSS 連携、素材取得スクリプトを NLMYTGen に追加する可能性はあるが、A-04 / D-02 は現在 `quarantined`。価値経路・権利・受け取り境界の個別再審査が済むまで通常候補として扱わない。
...
- `quarantined` 項目は boundary を越えていなくても、汚染バッチ由来なら通常候補として扱わない
