...
- next_action: H-02 strict GUI rerun proof 完了 (2026-04-06 pass)。packaging spec 定義は H-01〜H-04 全て proof 済み。コピー品質の実用改善は別課題として残る
- recommended_frontier_order: packaging spec lane は一巡完了。timeline lane は failure class または新 sample が出たときだけ局所再オープンする
...
- done: 35件（A-01〜A-02, A-04, B-01〜B-17, C-07 v3→v4, C-08, G-02, G-02b, G-05, G-06, G-07, G-08, G-09, G-10, G-11, G-12, G-13, H-02）
- approved: 3件（H-01, H-03, H-04）
- proposed: 0件
- info: 2件（C-01, C-06）
...
- H-02 closed。packaging spec lane は H-01〜H-04 全て proof 済み。timeline は新 sample または known failure class が出たときだけ再オープンする
