...
| new-banknote-existing-yymm4-evidence-revalidation-v1 | CONTENT_PROVENANCE / YMM4_EVIDENCE_RECONCILIATION | completed/current-lineage-compatible | Existing ignored project/result/batch state was reused read-only and remained byte/time/hash unchanged. Sanitized tracked evidence passes current approval, T00–T07, 9/3/6, exact text/order/timing compatibility; YMM4 was not rerun, audio quality is unknown, and G1 successor-branch integration audit is next. |
