...
| new-banknote-authoritative-source-script-v1 | INPUT_API_HUB / AUTHORITATIVE_SOURCE_TO_CANONICAL_SCRIPT | completed/source-backed-script-review-ready | Thirteen official captures support 19 verified-primary claims; all 182 claims are adjudicated, and the meaning-unit-traceable nine-cue 2/4/3 script plus canonical/derived CSV pair is ready for human review with zero unsupported spoken claims. |
