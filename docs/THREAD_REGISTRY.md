...
| new-banknote-yymm4-import-operator-batch-v1 | OUTPUT_VIDEO / YMM4_IMPORT_OPERATOR_BATCH_PREP | completed/operator-batch-ready | Frozen 9-row / 2-4-3 / 3-6 identities feed a deterministic Japanese-first batch; preflight and collect-only have YMM4 launch budget zero, local project/result/state remain ignored, and one manual import observation is pending. |
