...
| new-banknote-editorial-provenance-retrofit-v1 | INPUT_API_HUB / EDITORIAL_PROVENANCE | completed/human-visual-direction-selection-ready | All 425 characters are partitioned into 40 provenance spans across 9 cues, and all 38 substantive units expose source, operation, authority, approval, and uncertainty; prior finished user-script use is not proven from available repo evidence, 24 downstream identities are locked, and future substantive edits require a visible delta plus successor approval. |
