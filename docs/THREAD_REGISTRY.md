...
| new-banknote-content-lineage-yymm4-batch-v1 | CONTENT_PROVENANCE / YMM4_OPERATOR_BATCH_PREP | completed/lineage-sealed-operator-ready | Explicit option A approval locks eight approved hashes at `b05eb386`; T00–T07 and all 9 cues/15 claims/20 units/21 edges are inspectable, and a five-action user-operated YMM4 batch is preflight-passed without Worker YMM4 use. |
