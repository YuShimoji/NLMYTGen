...
| new-banknote-content-lineage-yymm4-batch-v1 | CONTENT_PROVENANCE / YMM4_EVIDENCE_RECONCILIATION | completed/lineage-sealed-existing-observation-reconciliation-ready | Explicit option A approval locks eight approved hashes at `b05eb386`; T00–T07 and all 9 cues/15 claims/20 units/21 edges are inspectable. Same-machine ignored import evidence already reports 9/3/6 and exact text/order, so the next move is non-overwriting current-lineage revalidation, not another YMM4 run. |
