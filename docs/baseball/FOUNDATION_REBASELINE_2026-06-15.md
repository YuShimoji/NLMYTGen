...
| BN-08 ScriptBeatIR linkage | `samples/_probe/baseball/pipeline/baseball_script_beat_ir_p05.json`, schema, readback, and manifest. | Script beats, supported claims, emphasis, timing hints, and visual intent are linked to validated Data Capsule refs. | It does not perform VisualScenePlan timing, visual redesign, YMM4 transport, render, production, source replacement, or publishing. |
...
| BN-08 ScriptBeatIR linkage | `samples/_probe/baseball/pipeline/baseball_script_beat_ir_p05_manifest.json` | Validates stable `beat_` refs, supported claims, Data Capsule reference resolution, timing hints, and visual intent boundaries. | Script linkage only; not VisualScenePlan storyboard, visual design V2, YMM4 motion transport, render proof, production readiness, or publish readiness. |
...
| BN-08 does not author the visual plan | ScriptBeatIR now exposes timing hints and visual intent, but final temporal slots remain VisualScenePlan ownership. | `samples/_probe/baseball/pipeline/baseball_script_beat_ir_p05_readback.json`. | Open BN-09 as VisualScenePlan timing linkage against linked beats. |
...
sample Data Capsule fixture and stable data refs. BN-08 later links only the
ScriptBeatIR sample to those refs.
