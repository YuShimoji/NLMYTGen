# Can do / Conditional / Cannot / Unknown

This surface is a decision aid, not a feature promise. Exact evidence and cost
records live in the adjacent JSON matrices.

## Can use now within a named observed boundary
...
- Validate one exact internal render and its proxy as decodable media (C4).

“Can” here does not imply arbitrary topics, arbitrary assets, production visual
quality, portability, rights clearance, or public readiness.
...
- Inspection, process and comparison composition fixtures through the same
  validator.

Each needs a relevant YMM4 observation before runtime use. Every composition has
a static or narration fallback.

## Cannot currently do in the generic core

- Non-fade transitions.
- Generic ShapeItem creation.
- Generic speech balloons.
- Automatic external asset discovery, download or rights clearance.
- Reuse the failed older card surface as a production design system.
...
- A schema, test or tracked project is not C3.
- A completed render without container/probe/decode evidence is not C4.
