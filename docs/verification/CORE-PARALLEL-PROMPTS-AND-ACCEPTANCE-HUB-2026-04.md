...
**並行の注意**: YMM4 を使う重い作業は **レーン C（視覚三スタイル）** と **P2 / 視覚最低限（Prompt-V）** が資源を奪い合う。人が 1 人なら **同時刻フル稼働は避け、時間分割**する（[PRE-PLAN-LANES-AND-CORE-DEV-2026-04-09.md](PRE-PLAN-LANES-AND-CORE-DEV-2026-04-09.md) §1）。
