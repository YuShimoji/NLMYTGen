...
- duplicate title handling: manual_review; do not auto-merge or auto-delete
...
- next human action: review the local-only candidate list in Inoreader UI and manually delete, replace, or keep feeds
