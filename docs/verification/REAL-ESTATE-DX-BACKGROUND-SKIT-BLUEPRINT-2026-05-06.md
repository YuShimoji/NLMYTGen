...
| `samples/_probe/g24/real_estate_dx_overlay_card_review_map.md` | reviewer-facing design memo for segment purpose, alternatives, rationale, weak assumptions, and actionable reviewer signals |
