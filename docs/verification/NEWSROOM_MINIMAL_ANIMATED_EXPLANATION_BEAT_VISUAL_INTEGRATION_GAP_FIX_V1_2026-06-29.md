...
artifact_id: newsroom_minimal_animated_explanation_beat_visual_integration_gap_fix_v1_2026_06_29
schema_version: newsroom_minimal_animated_explanation_beat_visual_integration_gap_fix.v1
production_status: diagnostic_only
render_gate: L0_no_render
selected_next_axis: newsroom-minimal-animated-explanation-beat-v2-preview-operator-instruction-v1
...
```json
{
  ...
  "git_check_ignore_result": {
    "command": "git check-ignore -v -- _tmp/newsroom_manual_probe/minimal_animated_explanation_beat_mainline_v2_visible_integration.ymmp",
    "returncode": 0,
    "stdout": ".gitignore:37:_tmp/\t_tmp/newsroom_manual_probe/minimal_animated_explanation_beat_mainline_v2_visible_integration.ymmp",
    "stderr": "",
    "ignored": true
  },
  "size": 232740,
...
```json
{
  ...
  "target_exists": true,
  "repo_relative_path": "_tmp/newsroom_manual_probe/minimal_animated_explanation_beat_mainline_v2_visible_integration.ymmp",
  "file_sha256": "001cc6e3c32eb545e25c810f228f9b24dd287404ac68cefb15ac8908e3f512b6",
  "file_size_bytes": 232740,
  "timeline": {
    "fps": 60,
    "length_frames": 720,
    "item_count": 17,
  ...
  "TextItem_count": 1,
  "ShapeItem_count": 0,
  "visible_text_item_count": 1,
  "visible_shape_item_count": 0,
  "visible_text_or_overlay_item_count": 1,
  "visible_TextItem_subtitle_card_or_overlay_exists": true,
  "visible_texts": [
...
```json
{
  "selected": "newsroom-minimal-animated-explanation-beat-v2-preview-operator-instruction-v1",
  "reason": "v2 local ignored probe exists, is ignored by git, and contains one visible TextItem plus the unchanged 16 animation items",
  "if_v1_already_had_visible_items": "newsroom-minimal-overlay-visibility-fix-v1",
  "if_materialization_not_worth_more_work": "newsroom-animation-accent-policy-closed-return-to-rss-dry-run-v1"
}
```
...
| gate | status |
| --- | --- |
| no_animation_only_probe | True |
| no_animation_tuning | True |
| no_primitive_loop | True |
| no_tempo_loop | True |
| no_card_polish_loop | True |
| no_render_export_loop | True |
| next_axis_is_visible_integration_preview | newsroom-minimal-animated-explanation-beat-v2-preview-operator-instruction-v1 |


## Boundary Note

V2 is an ignored local diagnostic .ymmp with one plain TextItem. It is not a card redesign, not a render proof, and not production/public acceptance.
