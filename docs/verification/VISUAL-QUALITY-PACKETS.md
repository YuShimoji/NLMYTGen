...
- Prompt-Bg-A1:
  - 「ファイル5のレーンCを進めてください。bg_animのA1（切替品質）だけ実施し、`VISUAL-QUALITY-PACKETS` のJSON形式で提出してください。」
- Prompt-Bg-A2:
  - 「ファイル5のレーンCを進めてください。bg_animのA2（速度品質）だけ実施し、PASS/NEEDS_FIXを提出してください。」
- Prompt-Bg-A3:
  - 「ファイル5のレーンCを進めてください。bg_animのA3（意図一致）だけ実施し、論点一致の証跡を提出してください。」
- Prompt-Bg-A4:
  - 「ファイル5のレーンCを進めてください。bg_animのA4（失敗クラス監視）だけ実施し、`BG_ANIM_*`/`TRANSITION_*` の発生有無を提出してください。」
- Prompt-Ov-B1:
  - 「ファイル5のレーンCを進めてください。overlayのB1（可読性）だけ実施し、小画面可読判定を提出してください。」
- Prompt-Ov-B2:
  - 「ファイル5のレーンCを進めてください。overlayのB2（情報密度）だけ実施し、過不足判定を提出してください。」
- Prompt-Ov-B3:
  - 「ファイル5のレーンCを進めてください。overlayのB3（タイミング一致）だけ実施し、同期証跡を提出してください。」
- Prompt-Ov-B4:
  - 「ファイル5のレーンCを進めてください。overlayのB4（レイヤ競合）だけ実施し、遮蔽/重なりの有無を提出してください。」
