...
| --- | --- | --- | --- |
| Inspect cockpit | Generate/update dashboard, JSON, launchers, access guide, screenshot, and validation ledger. | Open `docs/dashboard/index.html` through the launcher. | Human can see current state, next action, health, artifacts, and topic status before detailed evidence. |
