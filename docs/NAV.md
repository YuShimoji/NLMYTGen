...
- [verification/RSS-LIVE-SMOKE-RUNBOOK-2026-05-26.md](verification/RSS-LIVE-SMOKE-RUNBOOK-2026-05-26.md) — **A-04 RSS live smoke entry**: raw OPML/token 置き場、OPML/Inoreader smoke コマンド、sanitized evidence template、次の判断表
