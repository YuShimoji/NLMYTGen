...
- Repo-local operational enforcement (restart scope, core behavior, git-test policy, reporting intent, read order for agents) lives in `docs/REPO_LOCAL_RULES.md`.
