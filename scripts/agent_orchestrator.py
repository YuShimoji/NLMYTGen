...
def render_pre_execution_dry_run_preview(preview: dict[str, Any]) -> str:
    ...
    lines: list[str] = [
        ...
        "- Preview output location: stdout only",
        ...
        *_markdown_bullets(argv, "no argv entries were produced"),
        ...
        "- No real execution happened because this flow stops after rendering the preview.",
        "",
        "## Repo Status Summary",
        ...
        *_markdown_bullets(inspected_paths, "none"),
        ...
        "- preview output: stdout only; no .agent report, log, or needs-human artifact is written",
