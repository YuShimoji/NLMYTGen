...
ゆっくり解説動画の標準的な制作フロー。NLMYTGen は S-3（CSV変換）と S-6（背景・演出設定）支援を担当する。**制作工程は全て GUI で完結させる。CLI は開発・デバッグ用。**
...
| docs/verification/TACHIE-BODY-FACE-SWAP-PREP-2026-04-13.md | 立ち絵 複数体×顔差し替え準備（G-19/G-20 proposed・別スレッド Prompt） |
