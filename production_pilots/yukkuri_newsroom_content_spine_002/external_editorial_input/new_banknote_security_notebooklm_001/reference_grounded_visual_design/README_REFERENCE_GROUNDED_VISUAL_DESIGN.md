# Reference-Grounded Visual Design
...
- total references: **16**
- usable visually analyzed references: **14**
- official / educational usable: **4**
- journalism / documentary usable: **5**
- Yukkuri / adjacent explainer usable: **5**
- limited and not counted: **O03, O04**
- public no-login in-video frames: **3 frames / 3 independent channels**
- in-video frame references: **Y01, Y02, Y03**
- thumbnail-only references: **Y04, Y05**
